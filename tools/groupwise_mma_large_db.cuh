#ifndef LAB45_GROUPWISE_MMA_LARGE_DB_CUH
#define LAB45_GROUPWISE_MMA_LARGE_DB_CUH

#include <cstddef>
#include <cstdint>

namespace lab45_mma_large_db {
...
__device__ __forceinline__ void stage_tile(
    ...
    for (int vector = thread;
        ...
        copy_async_16(stage_b + row * kSharedK + column, source);
    }
    copy_async_commit();
}
...
void groupwise_mma_kernel(const int8_t* __restrict__ aq,
    ...
    __shared__ __align__(16)
        int8_t shared_a[kStages * kCtaM * kSharedK];
    __shared__ __align__(16)
        int8_t shared_b[kStages * kCtaN * kSharedK];
